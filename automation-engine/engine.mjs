 ...
 * ON-REAL-PATH:   NOT YET — первый же живой запуск после закрытия bugs/77 и bugs/79 обязан показать
 *                 строку «ЗАПРЕТ ВЛАДЕЛЬЦА: снят»; если её не будет, вызов стоит не на пути
 *
