  ...
  return {
    ...
    riders: {
      judgeArgs: ['--judge',
        ...
        '--rearm-healthy-ticks', String(TWIN_HEALTHY_TICKS_PER_SEC),
...
export async function selfTest() {
  ...
  ok('ВСАДНИКИ: судья двойника получает уставку окна здоровья СТЕНДА, а не живого пути (bugs/108)',
    [asmArmed.riders.judgeArgs.includes('--rearm-healthy-ticks'),
      asmArmed.riders.judgeArgs[asmArmed.riders.judgeArgs.indexOf('--rearm-healthy-ticks') + 1],
      TWIN_HEALTHY_TICKS_PER_SEC < 300],
    [true, String(TWIN_HEALTHY_TICKS_PER_SEC), true]);
