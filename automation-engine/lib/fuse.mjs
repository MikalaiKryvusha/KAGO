...
async function cmdSelftest() {
  ...
  // Замер прибора `npm run powerfloor` на этих двух: доля 0,217 против 0,855.
  {
    ...
    // =============================================================================================
    {
      ...
      {
        // 🟢 [ПОЛЕ --arm-p] — ДОЛГ ВХОДА 3 ЗАКРЫТ ЖИВЫМ ТРИПОМ, А НЕ МЕТКОЙ.
        //
        // Прогон 19:21 — первый за 08.09, который НЕ убил машину. Предохранитель сработал 9 раз,
        // и ДВА срабатывания пришлись на вход 3 (`power-collapse`) — первые за всю историю проекта.
        // До этого вечера вход 3 на живой карте не трипал НИ РАЗУ, и сторож `armed-proven-lint`
        // держал его в долге поля именно поэтому.
        //
        ...
        // [ПОЛЕ --arm-p] — запись прогона 19:21, девять спасений, машина жива.
        ...
        ok('🟢 ВХОД 3 ПОЛЕМ: запись 19:21 даёт трип power-collapse — первый живой трип входа 3 в проекте',
