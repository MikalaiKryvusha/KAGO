...
| 🔄 Stock Default | `npm run profile -- --reset` — полный сброс; ярлык сбрасывает мощность и частоту, но не сдвиги кривой (`bugs/140`, по коду) | починка `bugs/140` с живым свидетелем |
