...
🔴 **СЛЕДСТВИЕ ДЛЯ ФАЗЫ 4, И ОНО ВАЖНЕЕ САМОГО ЧИСЛА.** Вердикт стабильности стоит на ТРЁХ
наблюдениях (правило R4), и канарейка бесплатна только для двух из них. Третье — **работа в
секунду, детектор clock stretching**, — проседает ровно на эти 2,93 %. Значит, если канарейка едет
вместе с поиском края, эталон пропускной способности обязан быть снят **С НЕЙ**, иначе оракул будет
видеть постоянное «проседание частоты», которого нет. Это не мелочь: ложный SDC хуже пропущенного,
и проект за этот класс уже платил (EXP-0011, 58 ложных из 58).
