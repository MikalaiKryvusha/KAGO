...
- [ ] 1. **Свести реестр паритета** в `plans/59` из уже оплаченных оговорок (источники в схеме).
  Стартовый скелет строк: путь записи · вердикты оракула · сверка записи/классификатор ·
  закрепление/граница · журнал+пол зависания · спасение фьюза (обе руки) · тождество состояния
  руки 2 · тайминги носителя против модельных секунд · телеметрия/сэмплер · дрейф таблицы.
