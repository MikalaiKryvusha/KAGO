...
- [x] ✅ **Ш2. Развилка вынесена и ЗАКРЫТА ВЛАДЕЛЬЦЕМ 2026-08-31 17:33 (`interviews/024` = E).**
      ...
      каким числом.
- [ ] 🔄 **Ш3. ПЕРЕПИСАН ПОД ЕГО РЕШЕНИЕ: спасения ПОКАЗЫВАТЬ, но НЕ ОСТАНАВЛИВАТЬ.**
      Ш6 `plans/81`, сделанный мной утром, провёл спасения в накопитель, который ОСТАНАВЛИВАЕТ
      полосу, — то есть построил ровно то, что владелец запретил. Убрать из решения об остановке,
      оставить в сводке (P81-AC6).
      ⚠️ **Не трогать:** отказ АПВ (останавливает по-прежнему) · тормоз «два зависания подряд» ·
      почастотный счёт пульса и канала драйвера — про них владелец не говорил.
      🔴 **И не выбрасывать измерение:** «шесть срабатываний → две записи» остаётся верным фактом
      о ПОЧАСТОТНОЙ единице накопителя, и он понадобится, когда накопитель будут трогать ради
      пульса или драйвера.
