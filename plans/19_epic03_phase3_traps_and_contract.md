...
| **B3-AC7** | Acceleration is an argument: the bench does not shorten anything by itself. | Scale: seconds the bench subtracts from what the caller asked for · Meter: a block that asks for 6 s and measures the wall clock · **Target: 0 subtracted; ≥ 6 s actually elapsed** |
...
### 4.5 — The bench measures the engine — and names what is fixture, not engine 🔲
