...
- [ ] **Ш5. Замер цены (P83-AC5).** `npm run gfx -- --capture` до и после, чередованием, и разброс
      прибора рядом. **Пока этот замер не сделан, «замок бесплатен» произносить нельзя** — правило
      проекта про утверждения о разнице.
- [ ] **Ш6. Проба после остывания (P83-AC6)** — та самая, что нашла дефект: через ≥15 мин прочитать
      таблицу и посчитать превышение над максимумом.
