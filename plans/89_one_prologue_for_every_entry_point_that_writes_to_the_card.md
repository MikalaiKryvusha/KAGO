...
> **Что делать при исполнении Ш1:** либо сличать стабильную часть вывода (исключив строки живого
> чтения), либо сперва закрыть `bugs/112` и получить воспроизводимый вывод флагом. Второе лучше:
> тогда эталон снова становится годным инструментом, а не разовым обходом.
