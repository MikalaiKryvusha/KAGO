...
## 7. ✅ ГРАНИЦА РАЗВИЛКИ — РЕШЕНА ВЛАДЕЛЬЦЕМ 2026-08-31 10:40, ВАРИАНТ A

**Ответ через контур, расписка `interviews/decisions/interview_022_….decision.json`:** узкая
граница. Действующее правило, и оно теперь не предложение агента, а решение владельца:

> **Разведка перед решением обязательна там, где решение НЕОБРАТИМО, ЛИБО касается БЕЗОПАСНОСТИ
> КАРТЫ И МАШИНЫ ВЛАДЕЛЬЦА, ЛИБО меняет ТО, ЧТО ВЛАДЕЛЕЦ ВИДИТ И ЧИТАЕТ. Всё прочее — на
> усмотрение агента, с записью решения в тикет.**

Узость выбрана намеренно и с названной ценой: механизм, начавший с паралича, снимут через день, и
тогда его не станет вовсе (`bugs/75` — цена сторожа, кричащего впустую, измерена трижды). Расширять
по слову владельца дешевле, чем восстанавливать доверие к сторожу, который всех задолбал.

> 🔴 **ЗДЕСЬ СТОЯЛ САМ ВОПРОС, И ЭТО БЫЛО НАРУШЕНИЕМ** — канон: *«Всё, что агент хочет ОТ
> владельца… живёт ТОЛЬКО в `interviews/`, никогда в хвосте плана»*. Сторож краснел на этой строке
> и краснел правильно; агент читал его красноту как чужой долг ([[EXP-0211]]). Вопрос переехал в
> `interviews/022` Q3 целиком — с вариантами и доводом, а не ссылкой на них, — и там получил ответ.
