...
**Статус:** 📝 ЧЕРНОВИК, ни один шаг не начат — написан офлайн, пока Ф1 не кончилась, чтобы вечер 25.09 ~19:00 не
ждал плана. Утверждается, когда кончится Ф1 (дым Ш8 + судья Ш9, `plans/102`): что дым и судья покажут иначе —
правится здесь до первого шага.
...
| P103-AC5 | выгода против стока | `npm run validate -- --compare --stock <захваты стока> --mode <захваты режима>` | FPS · Вт · °C · обороты на плато; FPS не ниже стока на величину, превышающую разброс прибора; обороты ≤ 60 % |
