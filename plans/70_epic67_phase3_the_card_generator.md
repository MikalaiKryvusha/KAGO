...
**Открыто (следующая сессия): шаг 6** — сквозной дым `--sweep` на сгенерированной карте: нужен
флаг файла карты у движка/сборки (`makeTwinAssembly({cardFile})` есть, CLI-двери нет) — вместе с
ним мутации шага 5 (посев · счётчик перевыборок). §Итог станет финальным после этого.
