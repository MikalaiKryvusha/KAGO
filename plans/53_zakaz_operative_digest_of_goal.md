...
- [ ] 1. **Extract candidates:** walk `GOAL.md` (+ `MASTER_PLAN.md` mode table, `STATUS.md`
      ...
      **🟡 НАЧАТО 2026-08-29 00:2x (сессия 60): карта якорей снята МЕХАНИЧЕСКИ** (grep по
      ...
      | (8) автономия живых прогонов | + «🛑 ЛАГ ТЕЛЕМЕТРИИ — ОТКАЗ» · «⚡ ПРЕДОХРАНИТЕЛИ» · «🖥 ЦИФРОВОЙ ДВОЙНИК» | :1363/:1445 · :1470 · :1505/:1606 |
      ...
      **Осталось в шаге 1:** пройти участки :750–1639 глазами (читаны частично), снять ДАТЫ
      слова владельца к каждому якорю, свериться с таблицей режимов `MASTER_PLAN.md` и фактами
      STATUS 15–39 (что ОПРЕДЕЛЯЕТ, а не измеряет), пометить отменённые слои.
