...
- [x] ✅ **Ш6. СПАСЕНИЕ — В НАКОПИТЕЛЬ, ИСПОЛНЕН 2026-08-31.** Третий род `STALL_KIND.rescue`.
      ...
      **Зачем это было срочно:** Ш5 снял остановку вечера — значит череда спасений стала возможна, и
      замер её показал (9 на трёх частотах). Это риск (б), названный заранее и теперь измеренный.
