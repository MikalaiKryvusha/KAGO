...
- [ ] 🔴 **Ш4. Ступень узнаёт о спасении** (фаза A) — по расписке из Ш2, прочитанной ДВИЖКОМ перед
      прожигом. **РАЗБЛОКИРОВАН репро, но ЖДЁТ ВЛАДЕЛЬЦА:** форма починки — развилка, касающаяся
      предохранителя, то есть безопасности машины (`interviews/022` Q3 = A). Замер под развилку
      теперь есть; по правилу «на развилке — не решать самому» (`GOAL.md`, 2026-08-30) сперва
      разведка в `researches/`, потом вопрос в контур.
