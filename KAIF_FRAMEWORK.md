...
| Поле | Значение |
|------|----------|
| **Версия KAIF** | 2.5 «Experienced KAIF» |
| **Инъекция выполнена** | 2026-08-09 (KAIF 2.2) · обновлено до 2.3 механическим проходом 2026-08-28 · до 2.4 механическим проходом 2026-08-28 · до 2.5 bootstrap-маршрутом (тонкий `KAIF.md` + загрузчик: свежее ядро 2.5 вело этот же проход) 2026-09-04 |
