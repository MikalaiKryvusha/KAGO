...
| Поле | Значение |
|------|----------|
| **Версия KAIF** | 2.7 «Audited KAIF» |
| **Инъекция выполнена** | 2026-08-09 (KAIF 2.2) · обновлено до 2.3 механическим проходом 2026-08-28 · до 2.4 механическим проходом 2026-08-28 · до 2.5 bootstrap-маршрутом (тонкий `KAIF.md` + загрузчик: свежее ядро 2.5 вело этот же проход) 2026-09-04 · до 2.7 тем же bootstrap-маршрутом одним прыжком через 2.6 (свежее ядро 2.7, проход привязан к расписке репетиции в копии дерева) 2026-09-18 <!-- KAIF-VERSION-OK: строка — летопись обновлений, старые версии в ней названы как история --> |
