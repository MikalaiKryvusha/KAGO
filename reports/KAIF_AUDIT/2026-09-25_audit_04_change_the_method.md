...
3. **Ваш ручной заказ 14.09 — не капитуляция, а правильный метод.** Кривая, построенная за один
   ...
   ✏️ *Поправка 2026-09-25 01:2x (сессия 102): «стоит с 14.09» неверно с 18.09 23:01 — после смены
   драйвера 610.88 → 616.92 режим при каждом входе отвергается воротами R6 (штамп профиля), карта
   стоит на заводских (`runs/shell/boot-apply.jsonl`: `degraded-to-factory` 18.09 и 19.09). Замер
   14.09 и его числа верны.*
