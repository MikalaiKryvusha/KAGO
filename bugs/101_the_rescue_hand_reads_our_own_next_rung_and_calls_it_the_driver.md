...
`clocks.gr`, n = 6, ramp from 1590); all seven archived furnace runs sit at 2812…2820 MHz. **The launch
...
≈ 955…1045 ms — **above M = 993 ms**. Armed as the plan was written, input 2 would trip on HEALTHY rungs
below ≈ 1050 MHz, and a trip closes the frequency as an edge (`interviews/023`): a per-operating-point
