...
**Status:** 🔧 FIX PENDING LIVE WITNESS — cause found and fixed in code 2026-09-25 20:2x (session 104, offline): an ESM
...
- The SAME check through the module's own exports (`planMix` · `openValidateJournal` · `makeCardSeams` · `runCheck` ·
  `writeCheckReport`) from an importing script: **clean, 8 runs that evening** (19:15 · 19:22 · 19:23 · 19:25 · 19:49 ·
  19:51 · 19:53 · 19:55), apply 1–4 s each.
...
## Root cause (confirmed offline, 2026-09-25 20:1x)
