...
1. ~~**Приёмка эпика 03 (`plans/16`)**~~ — ✅ **ЗАКРЫТО 2026-09-07 (сессия 86, дневной цикл).**
   ...
   (`plans/16` → «Вердикты приёмки, снятые 2026-09-07»). **Итог: восемь взяты, два частично.**
   ...
   - 🟡 **AC3** — побайтовая воспроизводимость по зерну есть; отчёт стенда НЕ несёт ни коммита, ни
     хеша профиля карты (`researches/10` §2.1 требует все три).
