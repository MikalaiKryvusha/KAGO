...
1. ~~**Приёмка эпика 03 (`plans/16`)**~~ — ✅ **ЗАКРЫТО 2026-09-07 (сессия 86, дневной цикл).**
   ...
   - 🟡 **AC2** — три зерна и восемь профилей есть, но утверждения «найденный край = заложенный +
     политика запаса» в наборах НЕТ: T1 меряет число ступеней, а не величину запаса.
