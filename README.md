...
(остаточных смещений 0)**. Машина осталась жива. Причина — карта на одной ступени сорвала
закрепление частоты и ушла на 700 МГц выше заказанной (`bugs/86`). До этого дня у предохранителя
было наблюдение только на двойнике; теперь оно есть там, где ходит владелец.
