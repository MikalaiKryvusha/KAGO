...
// ВЕРСИЯ ЧИТАЕТСЯ ИЗ МАНИФЕСТА, А НЕ ВПИСЫВАЕТСЯ. Номер, набранный руками внутри картинки, — ровно (KAIF-VERSION-OK: ниже — история чужого инцидента, а не заявление о версии)
